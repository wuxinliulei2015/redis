 ...
 * 
 * @version $Revision: 1627011 $
 * 
 * @since 2.0
 */
public class GenericObjectPool<T> extends BaseGenericObjectPool<T> implements ObjectPool<T>, GenericObjectPoolMXBean,
		UsageTracking<T>
{
	...
	/**
	 * 使用一个双端队列来存放空闲的对象,根据策略既可以使用先进先出也可以使用后进先出的策略获取可用对象
	 */
