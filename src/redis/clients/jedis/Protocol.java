...
public final class Protocol
{
	...
	/**
	 * 对返回的二进制流按照返回协议进行解析,读取出一条命令的返回值
	 * 
	 * @param is
	 *            输入流
	 * @return
