		...
		JedisClusterScriptingCommands
{
	...
	public JedisCluster(Set<HostAndPort> jedisClusterNode, int connectionTimeout, int soTimeout, int maxRedirections,
			final GenericObjectPoolConfig poolConfig)
	{
	...
	{
		return new JedisClusterCommand<ScanResult<Entry<String, String>>>(connectionHandler, maxRedirections)
		{
			@Override
	 ...
	 * 
	 * @see <a
	 *      href="https://github.com/xetorthio/jedis/issues/531">issue#531</a>
	 */
	@Deprecated
	@Override
